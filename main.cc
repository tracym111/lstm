...
int main(int argc, char **argv) {
  ...
  driver.RegisterLayer<lstm::EmbeddingLayer, std::string>("kEmbedding");
  driver.RegisterLayer<lstm::HiddenLayer, std::string>("kHidden");
  driver.RegisterLayer<lstm::LossLayer, std::string>("kLoss");
  driver.RegisterLayer<lstm::DataLayer, std::string>("kData");
  driver.RegisterLayer<lstm::UnrollLayer, std::string>("kUnroll");
